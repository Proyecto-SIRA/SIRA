...
namespace Atestados.UI.Controllers.Atestados
{
    public class ObraAdministrativaController : Controller
    {
        ...
        // POST: ObraAdministrativa/Editar
        [HttpPost]
        [ValidateAntiForgeryToken]
